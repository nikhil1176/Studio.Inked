  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        try {
          console.error = () => {}; // Suppress internal THREE.js console.error
        ...
        console.warn = () => {}; // Suppress deprecation warning
...
`;
    ...
    // Gold theme ke liye bright boost hack
    vec3 outRGB = mix(vec3(0.01), c * 1.5, lenv); // Palette colors ko 1.5x bright kiya hai jab movement ho
